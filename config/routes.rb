...
#                        letter_opener_web          /letters                                                                                          LetterOpenerWeb::Engine
#                       rails_health_check GET      /up(.:format)                                                                                     rails/health#show
#          user_zitadel_omniauth_authorize GET|POST /users/auth/zitadel(.:format)                                                                     users/omniauth_callbacks#passthru
#           user_zitadel_omniauth_callback GET|POST /users/auth/zitadel/callback(.:format)                                                            users/omniauth_callbacks#zitadel
